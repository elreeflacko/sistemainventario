<!-- Content Wrapper. Contains page content -->
  ...
  <!-- /.content-wrapper -->
  <?php
    $tipo_dispositivo_id = $_GET["id-tipo-dispositivo"];
    
    $item = "tipo_dispositivo_id";
    $valor = $tipo_dispositivo_id;

    $lista_tipo_dispositivos = ControladorDispositivos::ctrMostrarDispositivosTipo($item, $valor);    
  ?>
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Administrar <?php echo  $lista_tipo_dispositivos[0]["tipo_dispositivo_nombre"]; ?>
        <small>Panel de control</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php?action=inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Administrar  <?php echo $lista_tipo_dispositivos[0]["tipo_dispositivo_nombre"]; ?></li>
      </ol>
    </section>
    <section class="content">
      <div class="box">
          ...
          <table class="table table-bordered table-striped table-hover dt-responsive tablas" width="100%">
            ...
            <tbody>
              <?php
                  ...
                  foreach ($lista_tipo_dispositivos as $key => $value) {
                      ...
                      echo '<tr>
                              ...
                              <td>
                                <div class="btn-group">
                                  <button class="btn btn-info btn_ver_dispositivo" id-ver-dispositivo="'.$value["dispositivo_id"].'" data-toggle="modal" data-target="#modal_ver_dispositivo">
                                    <i class="fa fa-info"></i>
                                  </button>
                                  <button class="btn btn-warning btn_editar_dispositivo" id-dispositivo="'.$value["dispositivo_id"].'" data-toggle="modal" data-target="#modal_editar_dispositivo">
                                    <i class="fa fa-pencil"></i>
                                  </button>
                                  <a href="'.$ruta_memo.$value["dispositivo_id"].'" class="btn btn-success"  target="_blank">
