  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Sin asignar</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <tbody>
              <?php
                  if (isset($_GET["estado"])) {
                    ...
                    $dispositivos_sin_asignar = ControladorDispositivos::ctrMostrarEstadoDispositivos($item, $valor);

                    foreach ($dispositivos_sin_asignar as $key => $value) {
