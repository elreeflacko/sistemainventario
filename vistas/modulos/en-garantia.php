  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">En garantía</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <tbody>
              <?php
                  if (isset($_GET["estado"])) {
                    ...
                    $dispositivos_garantia =  ControladorDispositivos::ctrMostrarEstadoDispositivos($item, $valor);

                    foreach ($dispositivos_garantia as $key => $value) {
