            ...
            <tbody>
              <?php
                  if (isset($_GET["estado"])) {
                    ...
                    $dispositivos_seguro =  ControladorDispositivos::ctrMostrarEstadoDispositivos($item, $valor);

                    foreach ($dispositivos_seguro as $key => $value) {
