<?php
                   if (isset($_GET["tipo_dispositivo_id"])) {
                      $item = "tipo_dispositivo_id";
                      $valor = $_GET["tipo_dispositivo_id"];

                      $mostrar_dispositivos =  ControladorDispositivos::ctrMostrarDispositivosTipo($item, $valor);

                      foreach ($mostrar_dispositivos as $key => $value) {
                      ...
                      $mostrar_dispositivos =  ControladorDispositivos::ctrMostrarDispositivos($item, $valor);
                    ...
                    tablas
                    dispositivo_garantia,



                    $tipos_dispositivos = "<td class='text-uppercase'>Computadores</td>";
      $marcas ="";
      $modelos = "";
      $seriales = "";
      $activos = "";
      ...
      $secciones = "";
      $pesonas = "";
      $acciones = "<div class='btn-group'><button class=btn btn-info btn_ver_dispositivo id-dispositivo='' data-toggle='modal' data-target='#modal_ver_dispositivo'><i class='fa fa-info'></i></button><button class='btn btn-warning btn_editar_dispositivo' id-dispositivo='' data-toggle='modal' data-target='#modal_editar_dispositivo'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btn_eliminar_dispositivo' id-dispositivo=''><i class='fa fa-times'></i></button></div>";
